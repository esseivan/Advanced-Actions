...
/*
  private void Main()
       {
           frmSaisieSave Dialogue = new frmSaisieSave();
...
namespace Advanced_Actions
{
    ...
    /// </summary>
    public partial class frmSaisieSave : Form
    {
        #region Déclarations
        ...
        public bool BoxValeur
        {
            get
            {
                return _boxNewSave.Checked;
            }
        }
        ...
        public void SetControls(bool BoxVisible = true,  string BoxText = "", bool BoxChecked = true)
        {
            _boxNewSave.Visible = BoxVisible;
            _boxNewSave.Text = BoxText;
            _boxNewSave.Checked = BoxChecked;
        }
